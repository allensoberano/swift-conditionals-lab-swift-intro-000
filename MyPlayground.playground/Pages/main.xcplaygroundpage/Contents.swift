...
// write your code here
    func isForceWith(arg1: String)->Bool{
        if (arg1 == "Luke") || (arg1 == "Leia") || (arg1 == "Anakin") || (arg1 == "Obi") || (arg1 == "Wan")
            || (arg1 == "Yoda") || (arg1 == "Vader"){
            return true
        } else {
            return false
        }
...
*/
// write your code here
    func bankFraud(myBankAmount: Float, otherBankAmount: Float){
        if (otherBankAmount >= 10){
            _ = myBankAmount + 10
            _ = otherBankAmount - 10
        }
}
